...
# MOdified DCN encoder + baseline (feed forward ) Decoder
"""
...
from modules import RNNEncoder, SimpleSoftmaxLayer, BasicAttn, RNNEncoder1, RNNEncoder2, maybe_mask_affinity
...
class QAModel(object):
    ...
    def build_graph(self):
        ...
        blended_reps = tf.concat([context_hiddens, U], axis=2) # (batch_size, context_len, hidden_size*4)
