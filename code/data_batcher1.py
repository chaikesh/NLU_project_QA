...
class Batch(object):
    ...
    def __init__(self, context_ids, context_mask, context_tokens, context_length, qn_ids, qn_mask, qn_tokens, qn_length, ans_span, ans_tokens, uuids=None):
        """
        Inputs:
        ...
        self.context_length = context_length # addded for dcn
        
        self.qn_ids = qn_ids
        self.qn_mask = qn_mask
        self.qn_tokens = qn_tokens
        self.qn_length = qn_length
...
def refill_batches(batches, word2id, context_file, qn_file, ans_file, batch_size, context_len, question_len, discard_long):
    ...
    while context_line and qn_line and ans_line: # while you haven't reached the end
        ...
        # add to examples
        examples.append((context_ids, context_tokens, context_length, qn_ids, qn_tokens, qn_length, ans_span, ans_tokens))
    ...
    for batch_start in xrange(0, len(examples), batch_size):
        ...
        context_ids_batch, context_tokens_batch, context_length_batch, qn_ids_batch, qn_tokens_batch, qn_length_batch, ans_span_batch, ans_tokens_batch = zip(*examples[batch_start:batch_start+batch_size])

        batches.append((context_ids_batch, context_tokens_batch, context_length_batch, qn_ids_batch, qn_tokens_batch, qn_length_batch, ans_span_batch, ans_tokens_batch))
...
def get_batch_generator(word2id, context_path, qn_path, ans_path, batch_size, context_len, question_len, discard_long):
    ...
    while True:
        ...
        (context_ids, context_tokens, context_length, qn_ids, qn_tokens, qn_length, ans_span, ans_tokens) = batches.pop(0)
        #print(context_ids)
        ...
        batch = Batch(context_ids, context_mask, context_tokens, context_length, qn_ids, qn_mask, qn_tokens, qn_length, ans_span, ans_tokens)
